    ...
    <header id="header" class="split-menu " data-sticky-class="not-dark" data-responsive-class="not-dark">
        ...
        <div id="header-wrap">
            ...
            <div class="container clearfix">
                ...
                ============================================= -->
                <div id="logo">
                    <a href="{{ route('landing') }}" class="standard-logo" data-dark-logo="{{ URL::asset('/images/P2P Logo.png')}}"><img src="{{ URL::asset('/images/P2P Logo.png')}}" alt="UniP2P Logo"></a>
                </div><!-- #logo end -->
            ...
            <div class="footer-widgets-wrap clearfix">
                        ...
                        <div class="widget clearfix">
                            <div class="row clearfix">
                                <div class="col-md-8 bottommargin-sm clearfix" style="color:#888;">
                                    <img src="{{ URL::asset('/images/P2P Logo.png')}}" alt="UniP2P Logo" style="display: block;" class="bottommargin-sm">
                                    <p> UniP2P is an Online Platform that connects borrowers with lenders creating a peer to peer lending network.
                                        ...
                                        Join the biggest peer to peer Social lending network in Rwanda NOW</p>
                ...
                <div id="copyrights" class="nobg notoppadding ">
                    ...
                    <div class="container clearfix center">
                        ...
                        <div class="col-md-12 ">
                            Copyrights &copy; 2018 All Rights Reserved by UniP2P Inc.<br>
